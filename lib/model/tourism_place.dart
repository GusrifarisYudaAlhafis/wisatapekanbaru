...
var tourismPlaceList = [
  TourismPlace(
    name: 'RTH Putri Kaca Mayang',
    location: 'Kota Pekanbaru',
    description: 'RTH Putri Kaca Mayang adalah salah satu tempat wisata di Pekanbaru yang terletak di Jalan Jenderal Sudirman, tepatnya di depan kantor Gubernur Riau. RTH Putri Kaca Mayang ini merupakan taman kota yang dibangun oleh Pemerintah Kota Pekanbaru. Taman ini memiliki luas sekitar 1,5 hektar dan dibangun pada tahun 2015. Taman ini memiliki berbagai macam fasilitas yang bisa dinikmati oleh pengunjung, seperti jogging track, taman bermain anak, dan juga taman bunga. Selain itu, di taman ini juga terdapat patung Putri Kaca Mayang yang menjadi ikon taman ini. Taman ini juga menjadi salah satu tempat yang cocok untuk bersantai bersama keluarga, karena taman ini memiliki banyak spot yang instagramable.',
    openDays: 'Open Everyday',
    openTime: '09:00 - 20:00',
    ticketPrice: 'Rp 25000',
    imageAsset: 'images/putri-kaca-mayang.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    location: 'Kota Pekanbaru',
    description: 'Taman Wisata Alam Mayang adalah salah satu tempat wisata di Pekanbaru yang terletak di Jalan Jenderal Sudirman, tepatnya di depan kantor Gubernur Riau. RTH Putri Kaca Mayang ini merupakan taman kota yang dibangun oleh Pemerintah Kota Pekanbaru. Taman ini memiliki luas sekitar 1,5 hektar dan dibangun pada tahun 2015. Taman ini memiliki berbagai macam fasilitas yang bisa dinikmati oleh pengunjung, seperti jogging track, taman bermain anak, dan juga taman bunga. Selain itu, di taman ini juga terdapat patung Putri Kaca Mayang yang menjadi ikon taman ini. Taman ini juga menjadi salah satu tempat yang cocok untuk bersantai bersama keluarga, karena taman ini memiliki banyak spot yang instagramable.',
